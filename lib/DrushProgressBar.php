...
function drush_create_progress($withEta = true, $onlyVerbose = false) {
  return \DrushProgressBar::create($withEta = true, $onlyVerbose = false);
}
...
class DrushProgressBar
{
     ...
     */
    public static function create($withEta = true, $onlyVerbose = false)
    {
        return new self($withEta, $onlyVerbose);
    }
